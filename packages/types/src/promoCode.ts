 ...
 */
export function promoPriceFor(baseRupees: number, discountPercent: number): number {
 ...
 */
export function discountPercentFor(amount: number, originalAmount: number): number {
