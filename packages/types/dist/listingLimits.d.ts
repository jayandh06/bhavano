...
export declare const MAX_PRICE_RENTAL = 1000000;
/**
 ...
 */
export declare function maxPriceFor(transactionType: TransactionType): number;
/**
 ...
 */
export declare function clampPrice(value: string, transactionType: TransactionType | null | undefined): string;
...
export declare function clampDigits(value: string, maxDigits: number | undefined): string;
