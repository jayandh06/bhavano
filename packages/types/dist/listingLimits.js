...
exports.MAX_PRICE_RENTAL = 1_000_000;
/**
 ...
 */
function maxPriceFor(transactionType) {
    return transactionType === "buy" || transactionType === "sell" ? exports.MAX_PRICE_SALE : exports.MAX_PRICE_RENTAL;
}
/**
 ...
 */
function clampPrice(value, transactionType) {
    const digits = value.replace(/[^0-9]/g, "").replace(/^0+(?=\d)/, "");
    if (digits === "" || transactionType == null)
        return digits;
...
function clampDigits(value, maxDigits) {
