...
export declare const TOPICS_WITH_LISTING_URL: ReadonlySet<ContactTopic>;
/** Likewise for the Razorpay payment id, which turns a payment complaint into a lookup. */
export declare const TOPICS_WITH_PAYMENT_ID: ReadonlySet<ContactTopic>;
export declare const MESSAGE_MIN_LENGTH = 20;
...
export declare const ACCEPTED_ATTACHMENT_MIME_TYPES: readonly ["image/jpeg", "image/png", "image/webp", "image/gif", "image/heic", "image/heif"];
...
export declare const MIN_DWELL_MS = 3000;
