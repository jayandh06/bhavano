    ...
    data: [
      {
        ...
        attributes: { beds: 3, sqft: 1450, furnished: 'semi' },
        ownerId: owner.id,
      ...
      },
      {
        ...
        attributes: { beds: 4, sqft: 2200, furnished: 'furnished' },
        ownerId: owner.id,
        expiresAt: defaultExpiresAt,
      },
      {
      ...
      },
      {
        ...
        attributes: { beds: 2, sqft: 980, furnished: 'furnished' },
        ownerId: owner.id,
        expiresAt: defaultExpiresAt,
      },
      {
        ...
        attributes: { beds: 2, sqft: 1100, furnished: 'unfurnished' },
        ownerId: owner.id,
        expiresAt: defaultExpiresAt,
      },
      {
