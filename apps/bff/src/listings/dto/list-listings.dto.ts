...
// 'auto' (default) is the recent-listings mix + boosted-page-cap
// (docs/plans/homepage-category-mix-and-boost-page-cap.md); 'newest' is a literal, un-mixed
// posting-date order — boosted listings still sort first (uncapped), same as 'price_asc'/
// 'price_desc'/'popular', just ordered by createdAt instead. See ListingsService's
// `wantsExplicitSort`.
