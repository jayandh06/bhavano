#!/usr/bin/env bash
# Downloads/refreshes the MaxMind GeoLite2-City database used by the BFF's GeoIpService to guess
# a first-time visitor's city (docs/plans/visitor-location-default-city.md).
#
